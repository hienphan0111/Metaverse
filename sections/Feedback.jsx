  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative"
      >
        ...
        <div >
          ...
          <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-22px leading-[39px] text-white">
      ...
      >
        <img src="/planet-09.png" alt="planet-09"
          className="w-ful lg:h-[610px] h-auto min-h-[210px] object-cover rounded-[40px]"
        />
